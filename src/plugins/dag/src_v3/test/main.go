...
func main() {
	...
	steps := []test_v2.Step{
		...
		{Name: "15 Thumbs: Switch To Build Mode", RunWithContext: wrapRun(ctx, Run11SwitchToBuildMode), SectionID: "dag-3d-stage"},
		{Name: "16 Thumbs: Build Mode Buttons A", RunWithContext: wrapRun(ctx, Run11BuildModeCoverageA), SectionID: "dag-3d-stage"},
		{Name: "17 Thumbs: Build Mode Buttons B", RunWithContext: wrapRun(ctx, Run11BuildModeCoverageB), SectionID: "dag-3d-stage"},
		{Name: "18 Thumbs: Switch To Layer Mode", RunWithContext: wrapRun(ctx, Run12SwitchToLayerMode), SectionID: "dag-3d-stage"},
		{Name: "19 Thumbs: Layer Mode Buttons A", RunWithContext: wrapRun(ctx, Run13LayerModeCoverageA), SectionID: "dag-3d-stage"},
		{Name: "20 Thumbs: Layer Mode Buttons B", RunWithContext: wrapRun(ctx, Run14LayerModeCoverageB), SectionID: "dag-3d-stage"},
		{Name: "21 Thumbs: Switch To View Mode", RunWithContext: wrapRun(ctx, Run15SwitchToCameraMode), SectionID: "dag-3d-stage"},
		{Name: "22 Thumbs: View Mode Buttons A", RunWithContext: wrapRun(ctx, Run16CameraModeCoverageA), SectionID: "dag-3d-stage"},
		{Name: "23 Thumbs: View Mode Buttons B", RunWithContext: wrapRun(ctx, Run17CameraModeCoverageB), SectionID: "dag-3d-stage"},
