...
func main() {
	steps := []test_v2.Step{
		...
		{Name: "08 Status Section Validation", Run: Run13TableSectionValidation, SectionID: "status", Screenshot: "screenshots/test_step_3.png"},
	...
	if err := test_v2.RunSuite(test_v2.SuiteOptions{
		Version:    "src_v1",
		ReportPath: "src/plugins/cloudflare/src_v1/test/TEST.md",
		LogPath:    "src/plugins/cloudflare/src_v1/test/test.log",
	}, steps); err != nil {
