...
**Generated at:** Tue, 17 Mar 2026 16:15:39 -0700
**Version:** `repl-src-v3`
**Runner:** `test/src_v1`
**Status:** ✅ PASS
**Total Time:** `13.925875465s`

## Test Steps

| Step | Result | Duration |
|---|---|---|
| tmp-bootstrap-workspace | ✅ PASS | `253.484µs` |
| dialtone-help-surfaces | ✅ PASS | `1.396815537s` |
| injected-tsnet-ephemeral-up | ✅ PASS | `2.791477111s` |
| interactive-add-host-updates-dialtone-json | ✅ PASS | `422.426847ms` |
| interactive-help-and-ps | ✅ PASS | `5.616379ms` |
| interactive-foreground-subtone-lifecycle | ✅ PASS | `406.60018ms` |
| main-room-does-not-mirror-subtone-payload | ✅ PASS | `451.307456ms` |
| interactive-background-subtone-lifecycle | ✅ PASS | `958.141263ms` |
| ps-matches-live-subtone-registry | ✅ PASS | `1.692235533s` |
| interactive-nonzero-exit-lifecycle | ✅ PASS | `408.413145ms` |
| multiple-concurrent-background-subtones | ✅ PASS | `1.381519669s` |
| interactive-ssh-wsl-command | ✅ PASS | `1.980779541s` |
| interactive-cloudflare-tunnel-start | ✅ PASS | `73.074µs` |
| subtone-list-and-log-match-real-command | ✅ PASS | `1.239232913s` |
| interactive-subtone-attach-detach | ✅ PASS | `790.917877ms` |
