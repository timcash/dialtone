...
**Generated at:** Sun, 15 Mar 2026 13:39:48 -0700
**Version:** `repl-src-v3`
**Runner:** `test/src_v1`
**Status:** ✅ PASS
**Total Time:** `39.799567875s`

## Test Steps

| Step | Result | Duration |
|---|---|---|
| tmp-bootstrap-workspace | ✅ PASS | `241.334µs` |
| dialtone-help-surfaces | ✅ PASS | `1.841861459s` |
| interactive-add-host-updates-dialtone-json | ✅ PASS | `1.790954125s` |
| interactive-help-and-ps | ✅ PASS | `1.429829625s` |
| interactive-ssh-wsl-command | ✅ PASS | `6.205650791s` |
| interactive-cloudflare-tunnel-start | ✅ PASS | `21.144373792s` |
| injected-tsnet-ephemeral-up | ✅ PASS | `1.457076958s` |
| subtone-list-and-log-match-real-command | ✅ PASS | `3.00376425s` |
| interactive-subtone-attach-detach | ✅ PASS | `2.925725167s` |
