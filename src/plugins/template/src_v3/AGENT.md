...
- `src/plugins/template/src_v3/ui/src/style.css` -> `@import '../../../../../plugins/ui/style.css';`
...
1. Diff `src/plugins/ui/style.css` against `src_v3/ui/src/style.css` and align base variables/layout primitives.
