...
**Generated at:** Fri, 13 Feb 2026 11:14:21 -0800
**Version:** `src_v3`
**Runner:** `test_v2`
**Status:** ✅ PASS
**Total Time:** `12.934s`
...
|---|---|---|
| 01 Preflight (Go/UI) | ✅ PASS | `5.725s` |
| 02 Go Run | ✅ PASS | `627ms` |
| 03 UI Run | ✅ PASS | `755ms` |
| 04 Expected Errors (Proof of Life) | ✅ PASS | `1.426s` |
| 05 Dev Server Running (latest UI) | ✅ PASS | `772ms` |
| 06 Hero Section Validation | ✅ PASS | `58ms` |
| 07 Docs Section Validation | ✅ PASS | `305ms` |
| 08 Table Section Validation | ✅ PASS | `341ms` |
| 09 Three Section Validation | ✅ PASS | `311ms` |
| 10 Xterm Section Validation | ✅ PASS | `315ms` |
| 11 Video Section Validation | ✅ PASS | `402ms` |
| 12 Lifecycle / Invariants | ✅ PASS | `1.696s` |
| 13 Cleanup Verification | ✅ PASS | `200ms` |
...
[T+0000] [2026-02-13T11:14:09.065-08:00 | INFO | go.go:RunGo:33] Running: go [fmt ./src/plugins/template/src_v3/...]
[T+0000] >> [TEMPLATE] Vet: src_v3
[T+0001] [2026-02-13T11:14:09.662-08:00 | INFO | go.go:RunGo:33] Running: go [vet ./src/plugins/template/src_v3/...]
[T+0001] >> [TEMPLATE] Go Build: src_v3
[T+0001] [2026-02-13T11:14:10.386-08:00 | INFO | go.go:RunGo:33] Running: go [build ./src/plugins/template/src_v3/...]
...
[T+0005] dist/assets/index-A0MCkHYl.css    4.63 kB │ gzip:   1.41 kB
...
[T+0005] dist/assets/index-nleHRQBf.js     9.12 kB │ gzip:   2.99 kB
...
[T+0006] [2026-02-13T11:14:14.771-08:00 | INFO | go.go:RunGo:33] Running: go [run src/plugins/template/src_v3/cmd/main.go]
...
[T+0006] $ vite --host "127.0.0.1" --port "64038"
[T+0006] 
[T+0006]   VITE v5.4.21  ready in 82 ms
[T+0006] 
[T+0006]   ➜  Local:   http://127.0.0.1:64038/
```
...
[T+0007] [2026-02-13T11:14:15.598-08:00 | INFO | chrome.go:StartSession:179] DEBUG: Launching Chrome: /Applications/Google Chrome.app/Contents/MacOS/Google Chrome [--remote-debugging-port=0 --remote-debugging-address=127.0.0.1 --remote-allow-origins=* --no-first-run --no-default-browser-check --user-data-dir=/Users/tim/code/dialtone/.chrome_data/dialtone-chrome-test-port-64043 --new-window --dialtone-origin=true --dialtone-role=test --headless=new]
...
[T+0009] $ vite --host "127.0.0.1" --port "64078"
[T+0009] 
[T+0009]   VITE v5.4.21  ready in 85 ms
[T+0009] 
[T+0009]   ➜  Local:   http://127.0.0.1:64078/
```
...
```text
[T+0011] [TEST] RUN   12 Lifecycle / Invariants
```

#### Browser Logs

```text
[T+0011] [log] [SectionManager] NAVIGATING TO #hero
[T+0011] [log] [SectionManager] NAVIGATE AWAY #video
[T+0011] [log] [SectionManager] PAUSE #video
[T+0011] [log] [SectionManager] NAVIGATE TO #hero
[T+0011] [log] [SectionManager] RESUME #hero
...
[T+0012] Cleaning up stale process on port 8080 (PID: 91106)...
```
