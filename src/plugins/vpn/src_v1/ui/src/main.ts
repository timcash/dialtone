...
sections.register('hero', {
  ...
  header: { visible: false, menuVisible: true, title: 'VPN v1' },
});
...
sections.register('docs', {
  ...
  header: { visible: false, menuVisible: true, title: 'VPN v1 Docs' },
});
...
sections.register('table', {
  ...
  header: { visible: false, menuVisible: true, title: 'VPN v1 Status' },
});
...
sections.register('three', {
  ...
  header: { visible: false, menuVisible: true, title: 'VPN v1 Mesh' },
});
...
sections.register('xterm', {
  ...
  header: { visible: false, menuVisible: true, title: 'VPN v1 Terminal' },
});
...
menu.addButton('Mesh', 'Navigate Mesh', () => {
...
const sectionOrder = ['hero', 'docs', 'table', 'three', 'xterm'] as const;
const wheelLockedSections = new Set(['table', 'three', 'xterm']);
