...
**Generated at:** Thu, 19 Mar 2026 15:49:41 -0700
**Version:** `chrome-src-v3`
**Runner:** `test/src_v1`
**Status:** ✅ PASS
**Total Time:** `25.515940568s`

## Test Steps

| Step | Result | Duration |
|---|---|---|
| chrome-deploy-and-start | ✅ PASS | `845.758681ms` |
| chrome-browser-pid-stable-across-commands | ✅ PASS | `3.312220307s` |
| chrome-reset-does-not-restart-browser | ✅ PASS | `2.851152954s` |
| chrome-managed-tab-count-stays-bounded | ✅ PASS | `2.94499331s` |
| chrome-single-browser-process-per-role | ✅ PASS | `3.19773994s` |
| chrome-no-recovery-window-for-role | ✅ PASS | `2.166183304s` |
| chrome-roles-do-not-share-browser-pid | ✅ PASS | `3.037287129s` |
| chrome-browser-actions-and-screenshot | ✅ PASS | `6.337763036s` |
| chrome-logs-and-status | ✅ PASS | `822.797352ms` |
...
## chrome-browser-actions-and-screenshot
