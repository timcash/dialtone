...
Goal for next agent:
- Improve UI styling to align with patterns from `src/plugins/ui/`
...
- `src/plugins/ui/style.css`

`src_v1` must import shared styles via:
- `src/plugins/robot/src_v1/ui/src/style.css` -> `@import '../../../../../plugins/ui/style.css';`
...
- `src/plugins/ui/style.css`
- `src/plugins/ui/SectionManager.ts`
- `src/plugins/ui/Menu.ts`
...
1. Diff `src/plugins/ui/style.css` against `src_v1/ui/src/style.css` and align base variables/layout primitives.
