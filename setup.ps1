...
Write-Host ""
Write-Host "IMPORTANT: Please configure your environment variables:"
Write-Host ""
Write-Host "\$env:DIALTONE_ENV = '$env:DIALTONE_ENV'"
Write-Host "\$env:PATH = '$env:DIALTONE_ENV\go\bin;$env:DIALTONE_ENV\node\bin;$INSTALL_DIR\bin;$env:PATH'"
Write-Host "To persist these changes, add them to your PowerShell profile (notepad \$PROFILE)."
