...
func init() {
	...
	test.Register("example-subtask", "stream-opencode-to-web-ui", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running stream-opencode-to-web-ui suite...")
	return test.RunTicket("stream-opencode-to-web-ui")
}
