...
func init() {
	...
	test.Register("example-subtask", "remove-plan-system", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running remove-plan-system suite...")
	return test.RunTicket("remove-plan-system")
}
