...
- name: ticket-start
- description: to start work run the cli command `dialtone.sh ticket start nats-ui-integration`
- test-description: run the ticket tests to verify that the ticket is in a valid state
- test-command: `dialtone.sh test ticket nats-ui-integration`
- status: todo
...
- test-command: `dialtone.sh ticket done nats-ui-integration`
- status: todo
