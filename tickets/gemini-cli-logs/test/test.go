...
func init() {
	...
	test.Register("example-subtask", "gemini-cli-logs", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running gemini-cli-logs suite...")
	return test.RunTicket("gemini-cli-logs")
}
