...
func init() {
	...
	test.Register("example-subtask", "create-go-plugin", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running create-go-plugin suite...")
	return test.RunTicket("create-go-plugin")
}
