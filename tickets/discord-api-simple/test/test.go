...
func init() {
	...
	test.Register("example-subtask", "discord-api-simple", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running discord-api-simple suite...")
	return test.RunTicket("discord-api-simple")
}
