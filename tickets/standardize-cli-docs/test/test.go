...
func init() {
	...
	test.Register("example-subtask", "standardize-cli-docs", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running standardize-cli-docs suite...")
	return test.RunTicket("standardize-cli-docs")
}
