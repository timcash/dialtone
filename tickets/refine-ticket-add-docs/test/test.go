...
func init() {
	...
	test.Register("example-subtask", "refine-ticket-add-docs", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running refine-ticket-add-docs suite...")
	return test.RunTicket("refine-ticket-add-docs")
}
