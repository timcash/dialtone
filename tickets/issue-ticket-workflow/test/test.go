...
func init() {
	...
	test.Register("example-subtask", "issue-ticket-workflow", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running issue-ticket-workflow suite...")
	return test.RunTicket("issue-ticket-workflow")
}
