...
func init() {
	...
	test.Register("example-subtask", "refactor-diagnostic-plugin", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running refactor-diagnostic-plugin suite...")
	return test.RunTicket("refactor-diagnostic-plugin")
}
