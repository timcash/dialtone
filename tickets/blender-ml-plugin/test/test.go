...
func init() {
	...
	test.Register("example-subtask", "blender-ml-plugin", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running blender-ml-plugin suite...")
	return test.RunTicket("blender-ml-plugin")
}
