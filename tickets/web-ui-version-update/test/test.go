...
func init() {
	...
	test.Register("example-subtask", "web-ui-version-update", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running web-ui-version-update suite...")
	return test.RunTicket("web-ui-version-update")
}
