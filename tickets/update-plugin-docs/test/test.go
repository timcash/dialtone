...
func init() {
	...
	test.Register("example-subtask", "update-plugin-docs", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running update-plugin-docs suite...")
	return test.RunTicket("update-plugin-docs")
}
