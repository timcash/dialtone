...
func init() {
	...
	test.Register("example-subtask", "debug-mavlink-ack-fail", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running debug-mavlink-ack-fail suite...")
	return test.RunTicket("debug-mavlink-ack-fail")
}
