...
func init() {
	...
	test.Register("example-subtask", "TEST-ticket-start-real", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running TEST-ticket-start-real suite...")
	return test.RunTicket("TEST-ticket-start-real")
}
