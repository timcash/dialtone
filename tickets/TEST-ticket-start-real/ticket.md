...
- name: ticket-start
- description: to start work run the cli command `dialtone.sh ticket start TEST-ticket-start-real`
- test-description: run the ticket tests to verify that the ticket is in a valid state
- test-command: `dialtone.sh test ticket TEST-ticket-start-real`
- status: todo
...
- test-command: `dialtone.sh ticket done TEST-ticket-start-real`
- status: todo
