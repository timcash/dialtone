...
func init() {
	...
	test.Register("example-subtask", "integrate-bubbletea-tui", []string{"example"}, RunExample)
}
...
func RunAll() error {
	logger.LogInfo("Running integrate-bubbletea-tui suite...")
	return test.RunTicket("integrate-bubbletea-tui")
}
