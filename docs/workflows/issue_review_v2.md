...
description: github issue triage workflow for LLM agents (v2 specific)
---

# Workflow: Issue Review & Ticket Preparation (v2)
...
This is the **Source of Truth** for the Dialtone Issue Management API (v2).
...
### Dialtone Ticket (`src/tickets_v2/<name>/ticket.md`)
```markdown
